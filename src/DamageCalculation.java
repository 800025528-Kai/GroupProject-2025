...
public class DamageCalculation{
    ...
    public double calculateDamage() {
        ...
        damage *= cc;
        double db = damageBoost();
        damage *= db;
        double wm = weakenMultiplier();
        damage *= wm;
        double dm = defMultiplier();
        damage *= dm;
        double rm = resistanceMultiplier();
        damage *= rm;
        double vm = vulerabilityMultiplier();
        damage *= vm;
        double mm = dmgMitigationMultiplier();
        damage *= mm;
        double bm = brokenMultiplier();
        damage *= bm;
        return damage;
    }
